	  ...
	  _createClass(Interactive, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_reactLab2['default'], { interactive: _interactiveJson2['default'], model: _modelJson2['default'], height: '380px', playing: this.state.labPlaying,
