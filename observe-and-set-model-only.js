...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactLab = __webpack_require__(189);

	var _reactLab2 = _interopRequireDefault(_reactLab);

	var _interactiveJson = __webpack_require__(190);

	var _interactiveJson2 = _interopRequireDefault(_interactiveJson);

	var _modelJson = __webpack_require__(191);

	var _modelJson2 = _interopRequireDefault(_modelJson);

	// These properties can be set directly in the interactive JSON too.
	_interactiveJson2['default'].showTopBar = false;
	_interactiveJson2['default'].showBottomBar = false;
	_interactiveJson2['default'].template = "model-only";
	_interactiveJson2['default'].theme = "no-framing";
	_interactiveJson2['default'].padding = 0;
	delete _interactiveJson2['default'].components;
	delete _interactiveJson2['default'].layout;
	...
	var Interactive = (function (_React$Component) {
	  ...
	  _createClass(Interactive, [{
	    ...
	    value: function handlePlayingChange(event) {
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_reactLab2['default'], { interactive: _interactiveJson2['default'], model: _modelJson2['default'], width: '450px', height: '300px', playing: this.state.labPlaying,
	        ...
	        _react2['default'].createElement(
	          ...
	          null,
	          'Playing: ',
	          _react2['default'].createElement('input', { type: 'checkbox', checked: this.state.labPlaying, onChange: this.handlePlayingChange })
	        ),
	        _react2['default'].createElement(
	          'div',
	          null,
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var Lab = (function (_React$Component) {
		  ...
		  _createClass(Lab, [{
		    ...
		    key: 'render',
		    value: function render() {
		      return _react2['default'].createElement('iframe', { ref: 'iframe', width: this.props.width, height: this.props.height,
		        frameBorder: '0', allowFullScreen: true, src: this.props.embeddableSrc });
		    }
	...
	module.exports = {
		...
		"atoms": {
			...
			"vx": [
				...
				-0.000298136042116943,
				0.00006062424470153571,
				0.0002044737406286467,
				-0.0002839074870632037,
				0.000011446058103833687,
				-0.0006256006234204845,
				-0.0001996846111673089,
				0.0006384037433562123,
				-0.0000798669759559107,
				0.00017618742576889696,
				0.0003223657189364907,
				0.00041019542722536996,
				-0.0001818352313866722,
				-0.000015737779164020056,
				-0.0002241265113733162,
				-0.00010774367837996895,
				-0.00007770903055937141,
				-0.00047397475088053256,
				-0.0000389212143648172,
				-0.00009569218645992819,
				0.00002149699577777483,
				-0.0001094067981893344,
				0.00030897524275971057,
				0.00003020712872133779,
				-0.00001716738703219066,
				0.00005735245273760502,
				-0.0000639728169071597,
				-0.00021344176190153804,
				0.00008667588113264002,
				0.00009304481503106575,
				0.0004117344844048052,
				0.00030233573352261335,
				0.0001717822414844713,
				-0.00017995045743225593,
				0.00039616839287788156,
				-0.00006792876510224033,
				0.0003237133607411012,
				0.000058934986534891446,
				0.00036896682887081934,
				0.00016612365843525864,
				-0.00009929164621592345,
				-0.0001617240471746045,
				0.0002725330844117096,
				0.00008483403136956475,
				0.00030426724330195534,
				-0.0002837356666017056,
				-0.00027903476616029325,
				-0.00013804452841008967,
				-0.00013746476176344422,
				-0.00012579724977827166,
				0.000002607280616139855,
				0.000012716126414778681,
				0.0002073052038507919,
				0.000265579565974325,
				0.000012040022857906201,
				0.00007962527804227074,
				-0.00025997708877895066,
				0.00008706384269812167,
				0.00007400198902475847,
				-0.00005225302985900522,
				-0.00009206119078367446,
				-0.000025833178211241694,
				0.0000018243711713447494,
				0.00021780015084329473,
				0.00007172828025171168,
				0.00031647529507359293,
